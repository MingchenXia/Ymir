...
\begin{proof}
    ...
    \]
    In particular, the maps in both cases are well-defined. We observe that the fiber of a point $x\in \Sp A$ under $\Sp   (A\otimes_k K)\rightarrow \Sp A$ can be identified with the image of $\Sp \mathscr{H}(x)\otimes_k K$ in $\Sp A\otimes_k K$. Observe that $\Sp \mathscr{H}(x)\otimes_k K$ is just the set of maximal ideals

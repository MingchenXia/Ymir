...
\begin{thm}\label{thm-hCnidentification}
...
\end{definition}
We will show in \cref{ConstructionComplex-cor-immersiongeneralnotion} in \nameref{ConstructionComplex-chap-constructionComplex} that our notion of immersion is the same as the general notion of immersions in the sense of ringed spaces.
...
\begin{corollary}\label{cor-CASCatfinitecom}

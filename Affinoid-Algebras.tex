...
\begin{example}
    ...
    \[
        (\Sp A)\left\{r^{-1}f,sg^{-1}\right\}:=\left\{x\in \Sp A: |f_i(x)|\leq r_i, |g_j(x)|\geq q_j, 1\leq i\leq n, 1\leq j\leq m\right\}.  
    \]
    ...
    $A[f,g^{-1}]$ is dense in $\left\{r^{-1}f,sg^{-1}\right\}$. We will therefore identify $\Sp A\left\{r^{-1}f,sg^{-1}\right\}$ with a subset of $\Sp A$. Let $x\in \Sp A$ corresponding to a bounded semi-valuation $|\bullet|_x$ on $A$. We need to find the condition such that $|\bullet|_x$ extends to a bounded semi-valuation on $A\left\{r^{-1}f,sg^{-1}\right\}$.
\end{example}

...
\begin{proposition}\label{prop-laurentdomainfundamental}
    Let $A$ be a $k_H$-affinoid algebra. Then for any $x\in\Sp A$, any neighbourhood $U$ of $x$ in $\Sp A$ contains a $k_H$-Laurent domain in $\Sp A$ containing $x$.
\end{proposition}
\begin{proof}
    ...
    \]
    Then the $k_H$-Laurent domain $\Sp A\{ r'^{-1}f,sg'^{-1} \}$ is contained in $U$.
\end{proof}

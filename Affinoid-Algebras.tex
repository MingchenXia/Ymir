...
\end{proof}
\begin{remark}
    It is not true that any homomorphism of affinoid $k$-algebras is bounded. For example, if the valuation on $k$ is trivial. Take $0<p<q<1$ and consider the natural homomorphism $K_p\rightarrow K_q$. This homomorphism is bijective but not bounded.
\end{remark}

...
\begin{definition}
    ...
    We say $X$ is \emph{irreducible} if it is non-empty has only one irreducible component.
\end{definition}
...
\begin{proposition}\label{prop-pathtoXreg}
    Let $X$ be a reduced complex analytic space and $x\in X$. Then $x$ be be joined by a path to a point in $X^{\reg}$.
\end{proposition}
\begin{proof}

...
\begin{proof}
    ...
    \[
        ...
        \end{aligned}
    \]
    where $n\in \mathbb{N}$, $r=(r_1,\ldots,r_n)\in \mathbb{R}^n_{>0}$, $f_1,\ldots,f_n\in B$, $g_1,\ldots,g_n\in C$ and $\|f-g\|\leq t$, where the norm on $A$ is the quotient norm $A$ induced by
    \[
